		...
		<div class="container">
			<div class="flex-w flex-sb-m p-b-52">
				<div class="flex-w flex-l-m filter-tope-group m-tb-10">
					...
					<form action="product.php?filtro=tutto" method="post" class="stext-106 cl6 hov1 bor3 trans-04 m-r-32 m-tb-5" data-filter=".women" >
						<input type="submit" value="All Products">
					</form>

					<form action="product.php?filtro=donna" method="post" class="stext-106 cl6 hov1 bor3 trans-04 m-r-32 m-tb-5" data-filter=".women" >
						<input type="submit" value="Women">
					</form>

					<form action="product.php?filtro=uomo" method="post" class="stext-106 cl6 hov1 bor3 trans-04 m-r-32 m-tb-5" data-filter=".women" >
						<input type="submit" value="Men">
					</form>

					<form action="product.php?filtro=accessori" method="post" class="stext-106 cl6 hov1 bor3 trans-04 m-r-32 m-tb-5" data-filter=".women" >
				...
				<div class="dis-none panel-search w-full p-t-10 p-b-15">
					<div class="bor8 dis-flex p-l-15">
						...
						<input class="mtext-107 cl2 size-114 plh2 p-r-15" type="text" name="search-product" placeholder="Search" value="<?php $filtro?>">
					</div>	
				</div>
				...
				<div class="dis-none panel-filter w-full p-t-10">
					<div class="wrap-filter flex-w bg6 w-full p-lr-40 p-t-27 p-lr-15-sm"> 
						...
						<div class="filter-col2 p-r-15 p-b-27">
							...
							<ul>
								<li class="p-b-6">
									<a href="product.php?price=tutto" class="filter-link stext-106 trans-04 filter-link-active">
										All
									</a>
								</li>

								<li class="p-b-6">
									<a href="product.php?price=50" class="filter-link stext-106 trans-04">
										< $50.00
									</a>
								</li>

								<li class="p-b-6">
									<a href="product.php?price=100" class="filter-link stext-106 trans-04">
										< $100.00
									</a>
								</li>

								<li class="p-b-6">
									<a href="product.php?price=150" class="filter-link stext-106 trans-04">
										< $150.00
									</a>
								</li>

								<li class="p-b-6">
									<a href="product.php?price=200" class="filter-link stext-106 trans-04">
										< $200.00
									</a>
								</li>

								<li class="p-b-6">
									<a href="product.php?price=tutto" class="filter-link stext-106 trans-04">
										$200.00+
									</a>
								</li>
							</ul>
			...
			$dollaro='$';
				...
				if($filtro=='tutto' || $filtro==''){
					...
					$price=$_GET["price"];
					if($price=='tutto' || $price=='')
						$sql = "SELECT * FROM prodotto ";
					else{
						$sql = 'SELECT * FROM prodotto WHERE prezzo <= '.$price.'';
				}}else{
				$sql = "SELECT * FROM prodotto ";
				}
				$result = $conn->query($sql);
			...
			if ($result->num_rows > 0) {
					...
					<div class="block2">
						<div class="block2-pic hov-img0">
							...
							<div class="block2-txt-child1 flex-col-l ">
								...
								<a href="cancellaprod.php?canc='.$id.'" class="stext-104 cl4 hov-cl1 trans-04 js-name-b2 p-b-6">
									cancella
			   ...
			   $result = $conn->query($sql);
				  ...
				  while($row = $result->fetch_assoc()) {
						  if($row["Admino"]=1){
							  echo '<a href="product.php?cancio= 1">
								Cancella
							   </a>';
						  }else{
					...
					<div class="col-md-6 col-lg-7 p-b-30">
						<div class="p-l-25 p-r-30 p-lr-0-lg">
							<div class="wrap-slick3 flex-sb flex-w">
								...
								<div class="slick3 gallery-lb">
									<div class="item-slick3" data-thumb="'.$row["image"].'">
										<div class="wrap-pic-w pos-relative">
											<img src="'.$row["image"].'" alt="IMG-PRODUCT">
